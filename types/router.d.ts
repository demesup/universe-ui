...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/students/edit.[id]': RouteRecordInfo<'/students/edit.[id]', '/students/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/students/group.[id]': RouteRecordInfo<'/students/group.[id]', '/students/group/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/students/year.[id]': RouteRecordInfo<'/students/year.[id]', '/students/year/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
