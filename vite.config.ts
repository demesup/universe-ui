...
// local vite plugin
import { VitePluginDemesupDoc } from './vite-plugin/demesup-doc'
...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'UniVerse - you helper in the small and at the same time vast univerity',
        short_name: 'UniVerse',
