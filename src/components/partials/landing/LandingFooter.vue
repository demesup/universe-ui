<template>
  <footer class="demesup-footer">
    <div class="container">
      <!-- <div class="footer-head">
        <div class="head-text">
          <h3>Ready to get started?</h3>
          <p>Get your Demesup copy now</p>
        </div>
        <div class="head-action">
          <div class="buttons">
            <a
              href="https://themeforest.net/item/demesup-vuejs-3-admin-and-webapp-ui-kit/31053035"
          ...
          <div class="columns is-flex-tablet-p">
            ...
            <div class="column">
              <ul class="footer-column">
                <li class="column-header">Demesup</li>
      ...
      <div class="footer-copyright has-text-centered">
        <ul class="copyright">
          <li>
            <span role="img" aria-label="copyright">&copy;</span> 2024
          </li>
          <li>
            <a :href="'mailto:guzhansofia@gmail.com'">guzhansofia@gmail.com</a>
          </li>
          <li>
            All Rights Reserved.
          </li>
