...
export interface VFlexTableProps {
  ...
  subtable?: boolean
  noHeader?: boolean
  autoPartnerCustomInput?: boolean
}
...
@media (width <= 767px) {
  ...
  .flex-table.custom-input .flex-table-item .flex-table-cell:not(:first-child) {
    max-width: none;
  ...
  .flex-table.custom-input .flex-table-item .flex-table-cell {
    .custom-autocomplete {
      width: 80%;
    }
  }
